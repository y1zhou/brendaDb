...
vignette: >
  %\VignetteIndexEntry{brendaDb-vignette}
...
```{r, eval=FALSE}
DownloadBrenda(file="/path/to/textfile.txt")
```

The function downloads the file to your specified location. Now the text file can be loaded into R as a `tibble`:
```{r, eval=FALSE}
df <- ReadBrenda("/path/to/textfile.txt")
